...
# Cache our data
def load_df():
    csv_url = 'https://raw.githubusercontent.com/Hutchins-RAs/roundup/debug-gh-actions/data/wp_data.csv'
...
def load_status():
    txt_url = 'https://raw.githubusercontent.com/Hutchins-RAs/roundup/debug-gh-actions/streamlit/scraper_status.txt'
